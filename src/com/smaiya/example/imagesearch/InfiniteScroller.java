...
public abstract class InfiniteScroller implements OnScrollListener
{
	...
	public InfiniteScroller(int visibleThreshold) {
		this.visibleThreshold = visibleThreshold;
	}

	public InfiniteScroller(int visibleThreshold, int startPage) {
		this.visibleThreshold = visibleThreshold;
